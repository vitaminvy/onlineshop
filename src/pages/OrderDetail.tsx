...
export default function OrderDetail() {
  ...
  const order = useMemo(() => {
    try {
      ...
      const list: OrderSnapshot[] = raw
        ? (JSON.parse(raw) as OrderSnapshot[])
        : [];
    ...
    <Container>
      <div className="py-8">
        ...
        <p className="mt-1 text-gray-600">
          ...
          {order.items.reduce((a, it) => a + it.qty, 0)} items
        </p>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-12">
          <div className="rounded-lg border bg-white p-4 lg:col-span-7">
            ...
            <div className="mt-4 border-t pt-3 text-base space-y-1">
